        ...
        {isOpen && (
          ...
          >
            ...
            <a
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-sm text-anchor-text-muted hover:text-anchor-text hover:bg-anchor-border/50 transition-colors border-t border-anchor-border/50"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-anchor-teal">
