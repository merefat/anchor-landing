...
export const metadata = {
  ...
  description: 'Anchor Terms of Service',
};
  ...
  return (
    <div className="min-h-screen py-20 px-4" style={{ background: 'var(--anchor-base)' }}>
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl font-bold text-anchor-text mb-8">Terms of Service</h1>

        <div className="prose prose-invert max-w-none" style={{ color: 'var(--anchor-text-muted)' }}>
          <p className="text-lg">
            Terms of Service content will be added here. Please provide the text content from the Word document.
          </p>
        </div>
      </div>
    </div>
